...
The tool is deployed at [https://interview-bias-checker.streamlit.app/](https://interview-bias-checker.streamlit.app/) — not just running locally. My [`week-9/reflection.md`](week-9/reflection.md) explains what I built, who it is for, scope decisions I made, and what I would change next.

The biggest deployment problem I hit: Streamlit Cloud failed when the app lived in a folder named `week 9` because the space broke the path to `requirements.txt`. I renamed the folder to `week-9`, pushed to GitHub, and redeployed with main file path `week-9/app.py`.

---

## C2 — Code Literacy and Documentation

I documented the ruleset so someone else — or future me — can follow what the code does and why. [`week-9/README.md`](week-9/README.md) defines L1, L2, and L3 leading-language rules with detect-if lists, examples, and test tables aligned with the implementation in [`week-9/rules.py`](week-9/rules.py).
...
I evaluated AI-generated output before shipping it and made judgment calls about what to trust, override, or cut.
