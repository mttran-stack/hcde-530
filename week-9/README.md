...
The interview bias checker reviews interview questions and flags **leading language** that would steer participants toward a particular answer instead of letting them respond from their own experience. The tool's detection uses Python rules grounded in questionnaire-bias research (Choi & Pak, 2005). The tool checks for tag questions and forced agreement (L1), one-sided or loaded framing (L2), and embedded examples or suggested causes (L3).

## Who it is for

The interview bias checker is for **UX/HCD researchers, students learning about conducting research interviews, and anyone preparing human-subjects interview protocols** who want to check their questions. Not only is it a tool to ensure unbiased interview questions, but it also serves as an opportunity to learn from the feedback and understand how to construct more neutral questions. The checker **does not** catch every form of bias so personal judgment is required for context, tone, and question order.
...
1. Paste your questions into the textbox
2. Run analysis by clicking on "Analyze questions"
3. Review results and go over feedback for each question flagged. You can edit flagged questions or received suggested rewrites of the question
4. Reanalyze to see how many questions are neutral after editing your questions.
...
**Detect if** the question contains:
...
After you click **Analyze questions**, you will be met with a results page that shows how many questions out of the total number of questions are neutral and require review.
